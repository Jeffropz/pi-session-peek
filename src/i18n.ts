...
const zh = {
  ...
  hitOnlyMeta: "关键词仅命中会话名，对话正文无匹配",
  you: "👤 你",
  ai: "🤖 AI",
  renamePrefix: "✏ 重命名: ",
  confirmDelete: "⚠ 删除会话 [{desc}]？按 y / Enter 确认，任意其他键取消",
  footer: "↑↓ 选择  PgUp/Dn·^U/^F·⇧↑↓ 滚动  ^N/^P 命中  ^T 工具  Tab 范围  ^D 删除  ^R 改名  ^O 分叉  Enter 进入  Esc/^C 关闭  🖱 点选·双击进入·拖选·滚轮",
  selHint: "▭ 已选 {n} 行  ^C 复制  点击别处取消",
  copied: "✓ 已复制 {n} 行",
  copyFailed: "✗ 复制失败",
  since: "近{n}{unit}",
  unitH: "小时",
...
const en: Record<keyof typeof zh, string> = {
  ...
  hitOnlyMeta: "Keyword matched only the session name, not the conversation",
  you: "👤 You",
  ai: "🤖 AI",
  renamePrefix: "✏ Rename: ",
  confirmDelete: "⚠ Delete session [{desc}]? y / Enter to confirm, any other key to cancel",
  footer: "↑↓ select  PgUp/Dn·^U/^F·⇧↑↓ scroll  ^N/^P hits  ^T tools  Tab scope  ^D del  ^R rename  ^O fork  Enter open  Esc close  🖱 click·dbl-click·drag·wheel",
  selHint: "▭ {n} lines selected  ^C copy  click elsewhere to clear",
  copied: "✓ Copied {n} lines",
