...
const zh = {
  ...
  footer: "↑↓ 选择  PgUp/Dn·^U/^F·⇧↑↓ 滚动  ^N/^P 命中  ^T 工具  Tab 范围  ^D 删除  ^R 改名  ^O 分叉  Enter 进入  Esc/^C 关闭",
  since: "近{n}{unit}",
  unitH: "小时",
  unitD: "天",
  unitW: "周",
...
const en: Record<keyof typeof zh, string> = {
  ...
  footer: "↑↓ select  PgUp/Dn·^U/^F·⇧↑↓ scroll  ^N/^P hits  ^T tools  Tab scope  ^D del  ^R rename  ^O fork  Enter open  Esc close",
  since: "last {n}{unit}",
  unitH: "h",
  unitD: "d",
  unitW: "w",
